...
public class ActiveCharacterTest {
	...
	public void testComplexAttact(){
		...
		WereableWeapon weapon5 = new WereableWeapon("", "", 10, 10, 10, null, itemTypeWeapon, null, null, null, 30, 1);
	...
	public void testEquipItems() {
		...
		c5.equipArmor(armor4);
		WereableWeapon weapon5 = new WereableWeapon("", "", 10, 95, 0, null, itemTypeWeapon, null, null, null, 0, 0);
		...
		ActiveCharacter c3 = new ActiveCharacter("", "", "", null, null, position, 40, 
				...
				new ArrayList<Item>(), 0, 0);
		itemTypeWeapon.add(WeaponType.LEFTHAND);
		WereableWeapon weapon1 = new WereableWeapon("", "", 10, 0, 0, null, itemTypeWeapon, null, null, null, 0, 0);
		...
		WereableWeapon weapon2 = new WereableWeapon("", "", 10, 0, 0, null, itemTypeWeapon, null, null, null, 0, 0);
